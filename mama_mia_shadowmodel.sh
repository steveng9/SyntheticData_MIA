...
nohup python3 AAAI_mamamia_experiments.py shadowmodel D mst 0.10 > outfiles/D_0.10.txt &
...
nohup python3 AAAI_mamamia_experiments.py shadowmodel D mst 1000.00 > outfiles/D_1000.00.txt &

nohup python3 AAAI_mamamia_experiments.py shadowmodel D priv 0.10 > outfiles/D_priv_0.10.txt &
...
nohup python3 AAAI_mamamia_experiments.py shadowmodel D priv 1000.00 > outfiles/D_priv_1000.00.txt &

nohup python3 AAAI_mamamia_experiments.py shadowmodel D gsd 0.10 > outfiles/D_gsd_0.10.txt &
...
nohup python3 AAAI_mamamia_experiments.py shadowmodel D gsd 1000.00 > outfiles/D_gsd_1000.00.txt &


#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 0.10 > outfiles/D_rap_0.10.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 0.32 > outfiles/D_rap_0.32.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 1.00 > outfiles/D_rap_1.00.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 3.16 > outfiles/D_rap_3.16.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 10.00 > outfiles/D_rap_10.00.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 31.62 > outfiles/D_rap_31.62.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 100.00 > outfiles/D_rap_100.00.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 316.23 > outfiles/D_rap_316.23.txt &
#nohup python3 AAAI_mamamia_experiments.py shadowmodel D rap 1000.00 > outfiles/D_rap_1000.00.txt &
